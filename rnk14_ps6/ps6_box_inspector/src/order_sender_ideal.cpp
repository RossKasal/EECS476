...
int main(int argc, char ** argv) {
  ...
  //gear_part:
  product.type = "gear_part";  

  part_target_pose.position.x = -0.101238;
  part_target_pose.position.y = 0.184793;
  part_target_pose.position.z = 0.0;
  part_target_pose.orientation.x = 0.0;
  part_target_pose.orientation.y = 0.0;
  part_target_pose.orientation.z = -0.166;
  part_target_pose.orientation.w = 0.986;
  product.pose = part_target_pose;
  shipment.products.push_back(product);    

  //gasket_part:
  product.type = "gasket_part";  
  part_target_pose.position.x = -0.009;
  ...
  product.type = "gasket_part";  
  part_target_pose.position.x = 0.042;
  part_target_pose.position.y = -0.091;
  part_target_pose.position.z = 0.0;
  part_target_pose.orientation.x = 0.0;
  part_target_pose.orientation.y = 0.0;
  part_target_pose.orientation.z = 0.385;
