...
private:
    ...
    actionlib::SimpleActionServer<beta_action_server::pathAction> as_;
    
    // here are some message types to communicate with our client(s)
    beta_action_server::pathGoal goal_; // goal message, received from client
    beta_action_server::pathResult result_; // put results here, to be sent back to the client when done w/ goal
    beta_action_server::pathFeedback feedback_; // not used in this example; 
...
public:
    ...
    // Action Interface
    void executeCB(const actionlib::SimpleActionServer<beta_action_server::pathAction>::GoalConstPtr& goal);
};
...
void ExampleActionServer::executeCB(const actionlib::SimpleActionServer<beta_action_server::pathAction>::GoalConstPtr& goal) {
