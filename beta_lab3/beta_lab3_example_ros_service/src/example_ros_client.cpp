...
#include <ros/ros.h>
#include <beta_lab3_example_ros_service/ExampleServiceMsg.h> // this message type is defined in the current package
#include <iostream>
#include <string>
using namespace std;
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle n;
    ros::ServiceClient client = n.serviceClient<beta_lab3_example_ros_service::ExampleServiceMsg>("lookup_by_name");
    beta_lab3_example_ros_service::ExampleServiceMsg srv;
