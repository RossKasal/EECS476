...
#include <ros/ros.h>
#include <beta_lab3_example_ros_service/ExampleServiceMsg.h>
#include <iostream>
#include <string>
using namespace std;

bool callback(beta_lab3_example_ros_service::ExampleServiceMsgRequest& request, beta_lab3_example_ros_service::ExampleServiceMsgResponse& response)
{
