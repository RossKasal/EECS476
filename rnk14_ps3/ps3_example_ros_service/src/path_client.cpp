...
#include <ros/ros.h>
#include <ps3_example_ros_service/PathSrv.h> // this message type is defined in the current package
#include <iostream>
#include <string>
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle n;
    ros::ServiceClient client = n.serviceClient<ps3_example_ros_service::PathSrv>("path_service");
    ...
    ps3_example_ros_service::PathSrv path_srv;
