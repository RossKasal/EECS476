...
#include <ros/ros.h>
#include <ps3_example_ros_service/PathSrv.h>
...
void get_yaw_and_dist(geometry_msgs::Pose current_pose, geometry_msgs::Pose goal_pose,double &dist, double &heading) {
	double x_start, x_goal, y_start, y_goal;
...
bool callback(ps3_example_ros_service::PathSrvRequest& request, ps3_example_ros_service::PathSrvResponse& response)
{
