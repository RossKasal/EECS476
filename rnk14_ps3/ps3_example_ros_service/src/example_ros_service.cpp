...
#include <ros/ros.h>
#include <ps3_example_ros_service/ExampleServiceMsg.h>
#include <iostream>
#include <string>
using namespace std;

bool callback(ps3_example_ros_service::ExampleServiceMsgRequest& request, ps3_example_ros_service::ExampleServiceMsgResponse& response)
{
